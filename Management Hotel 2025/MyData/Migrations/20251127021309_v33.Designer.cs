            ...
            modelBuilder.Entity("Mydata.Models.Booking", b =>
                {
                    ...
                    b.Property<DateTime?>("RealTimeCheckIn")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("RealTimeCheckOut")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("TypePassenger")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Mydata.Models.Room", b =>
                {
                    ...
                    b.Property<decimal>("PricePrivate")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MyData.Models.Order", b =>
                {
                    b.HasOne("Mydata.Models.Booking", "Booking")
                        .WithOne("Orders")
                        .HasForeignKey("MyData.Models.Order", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
