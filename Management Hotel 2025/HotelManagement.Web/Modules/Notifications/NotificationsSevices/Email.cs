...
namespace Management_Hotel_2025.Modules.Notifications.NotificationsSevices
{
    public class Email : INotifications
    {
        ...
        private SmtpClient CreateSmtpClient()
        {
            ...
            return new SmtpClient(_configuration["Smtp:Host"] ?? "smtp.gmail.com", port)
            {
        ...
        {
            var address = _configuration["Smtp:UserName"]
                ?? throw new InvalidOperationException("Smtp:UserName is not configured.");
            return new MailAddress(address, _configuration["Smtp:FromName"] ?? "Hotel Management");
        }
